package com.pay.wechatpay.controller.wxpayutil;

import java.util.HashMap;
import java.util.Map;

import com.pay.ext.kit.PaymentKit;
import com.pay.ext.util.HttpUtils;
...
public class WxPayApi {
	...
	/**
	 * 交易类型枚举 统一下单接口trade_type的传参可参考这里 JSAPI--公众号支付、小程序支付 NATIVE--原生扫码支付
	 * APP--APP支付 WAP--WAP支付
	 * MICROPAY--刷卡支付,MWEB--h5支付,PAP--刷卡支付有单独的支付接口，不调用统一下单接口
	 */
	...
	/**
	 * 统一下单
	 * 服务商模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/native_sl.php?chapter
	 * =9_1
	 ...
	 * @return {String}
	 */
	public static String orderQuery(boolean isSandbox,
	...
	/**
	 * 撤销订单 服务商模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/micropay_sl.php?
	 * chapter=9_11&index=3
	 * 商户模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/micropay
	 * .php?chapter=9_11&index=3
	 * 
	 * @param params
	 *            请求参数
	 * @param certPath
	 ...
	 * @return {String}
	 */
	public static String orderReverse(Map<String, String> params,
	 ...
	 * @return {String}
	 */
	public static String orderRefund(boolean isSandbox,
	 ...
	 * @return {String}
	 */
	public static String orderRefundQuery(boolean isSandbox,
			Map<String, String> params) {
		if (isSandbox)
	 ...
	 * @return {String}
	 */
	public static String downloadBill(boolean isSandbox,
			Map<String, String> params) {
		if (isSandbox)
	...
	/**
	 * 交易保障 服务商模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/micropay_sl.php?
	 * chapter=9_14&index=7
	 * 商户模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/micropay
	 * .php?chapter=9_14&index=7
	 * 
	 * @param params
	 *            请求参数
	 * @return {String}
	...
	/**
	 * 转换短链接 服务商模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/micropay_sl.php?
	 * chapter=9_9&index=8
	 * 商户模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/micropay
	 * .php?chapter=9_9&index=8
	 * 
	 * @param params
	 *            请求参数
	 * @return {String}
	...
	/**
	 * 刷卡支付 服务商模式接入文档:https://pay.weixin.qq.com/wiki/doc/api/micropay_sl.php?
	 * chapter=9_10&index=1 商户模式接入文档:
	 ...
	 * @return {String}
	 */
	public static String transfers(Map<String, String> params, String certPath,
			String certPassword) {
		return WxPayApi
				.doPostSSL(TRANSFERS_URL, params, certPath, certPassword);
	}
	...
	public static String getTransferInfo(Map<String, String> params,
		...
		return WxPayApi.doPostSSL(GETTRANSFERINFO_URL, params, certPath,
				certPassword);
	}
	 ...
	 * @return {String}
	 */
	public static String payBank(Map<String, String> params, String certPath,
			String certPassword) {
	 ...
	 * @return {String}
	 */
	public static String queryBank(Map<String, String> params, String certPath,
			String certPassword) {
		return WxPayApi.doPostSSL(QUERY_BANK_URL, params, certPath,
				certPassword);
	}
	 ...
	 * @return {String}
	 */
	public static String getPublicKey(Map<String, String> params,
			String certPath, String certPassword) {
		return WxPayApi.doPostSSL(GETPUBLICKEY_URL, params, certPath,
				certPassword);
	}
	 ...
	 * @return {String}
	 */
	public static String getCodeUrl(String appid, String mch_id,
			String product_id, String partnerKey, boolean isToShortUrl) {
		...
		String qrCodeUrl = PaymentKit.replace(url, "XXXXX", packageSign, appid,
				mch_id, product_id, timeStamp, nonceStr);
		if (isToShortUrl) {
			String shortResult = WxPayApi.toShortUrl(PaymentKit
					.buildShortUrlParasMap(appid, null, mch_id, null,
	...
	/**
	 * 支付中签约
	 * https://pay.weixin.qq.com/wiki/doc/api/pap.php?chapter=18_13&index=2
	 * 
	 * @param params
	 *            请求参数
	 * @return {String}
